...
export async function solverInvalidParens(ns, arrayData) {
...
export async function solverWaysToSum(ns, arrayData) {
...
export async function solverWaysToExpress(ns, arrayData) {
...
export async function solverUniquePathsII(ns, arrayData) {
...
export async function solverUniquePaths(ns, arrayData) {
...
export async function solverTrianglePath(ns, arrayData) {
...
export async function solverStockTrader(ns, arrayData) {
...
export async function solverSpiralizeMatrix(ns, arrayData) {
...
export async function solverMergeRanges(ns, arrayData) {
...
export async function solverLargestSubset(ns, arrayData) {
...
export async function solverLargestPrime(ns, arrayData) {
...
export async function solverGenerateIPs(ns, arrayData) {
...
export async function solverArrayJumpingGame(ns, arrayData) {
    await ns.sleep(1000);
